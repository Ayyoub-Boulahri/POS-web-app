...
if (isset($_GET["devis"])) {
    ...
    $requete->execute();
    header("Location:facture_service.php?id_devis=" . $_GET["id_devis"]);
}
    ...
    <div class="bodyDiv">
        ...
        <header>
            ...
            <address style="width: 100%; display:flex;flex-direction:column;align-items:flex-end">
                <div>
                <p>Nom : <?php echo $devis["full_name_client"] ?></p>
                <p>ICE : <?php echo $devis["addresse"] ?></p>
                <p>Code Postal : <?php echo $devis["code_postal"] ?></p>
                <p>Tel : <?php echo $devis["tel"] ?></p>
                </div>
            </address>
        </header>
        <article>
